...
<style>
    ...
    .search-icon { position: absolute; left: 16px; top: 50%; transform: translateY(-50%); color: #6C3FE8; }

    .section-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px; }
    .section-title { font-size: 20px; font-weight: 700; color: #1F2937; font-family: 'Sora', sans-serif; }
    .notes-count { background: #EDE9FE; color: #5B21B6; font-size: 12px; font-weight: 600; padding: 4px 10px; border-radius: 99px; }
    ...
    .note-card-accent { height: 4px; background: linear-gradient(90deg, #6C3FE8, #9B6DFF); }
    ...
    .note-footer { padding: 12px 18px; border-top: 1px solid #F5F3FF; display: flex; justify-content: flex-end; gap: 8px; background: #FAFAFE; }

    .btn-edit { font-size: 13px; font-weight: 600; color: #5B21B6; padding: 6px 14px; border-radius: 99px; background: #EDE9FE; text-decoration: none; transition: background 0.15s; }
    ...
    .empty-state { text-align: center; padding: 60px 20px; background: white; border-radius: 24px; border: 2px dashed #DDD6FE; }
    ...
    .empty-btn { display: inline-block; background: #6C3FE8; color: white; padding: 12px 28px; border-radius: 99px; font-weight: 700; text-decoration: none; font-size: 14px; transition: transform 0.15s, box-shadow 0.15s; box-shadow: 0 4px 16px rgba(108,63,232,0.3); }
